...
def _call_llm(prompt, retries=1):
    ...
    return """## Summary
Automated code review fallback: external LLM services were temporarily unavailable.
...
## Suggestions
Verify LLM provider credentials and status.

## Verdict
⚠️ Needs Changes
External LLM review service unavailable."""
