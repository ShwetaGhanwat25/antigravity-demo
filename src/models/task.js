...
function validateEnums(status, priority) {
    // Fail Fast: Throw an Error with status 400 when enum validation fails
...
function update(id, data) {
    ...
    // 🛡️ Whitelist allowed fields to prevent mass assignment of sensitive metadata (e.g. id, createdAt)
