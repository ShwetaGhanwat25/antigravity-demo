...
function update(id, data) {
    ...
    // Whitelist only allowed fields to protect against mass assignment
    ...
    if (data.assignedTo !== undefined) allowedUpdates.assignedTo = data.assignedTo;

    tasks[index] = { ...tasks[index], ...allowedUpdates, updatedAt: new Date().toISOString() };
    return tasks[index];
}
